...
2,8,10,14,18,19,21 are illegal
...
print('x'+1) #جمع _اینتیجر_با_استرینگ_بی_معناس
...
print(list([i1 + i2,i1 / i2,i1 // i2,i2 / i1,i2 // i1,i1 * i3,d1 + d2,d1 / d2,d2 / d1,d3 * d1,d1 + i2,i1 / d2,d2 / i1,i2 / d1,i1/i2*d1,d1*i1/i2,d1/d2*i1,i1*d1/d2,i2/i1*d1,d1*i2/i1,d2/d1*i1,i1*d2/d1]))
...
x == 3,x < y,x >= y,x <= y,x != y - 2,x < 10,x >= 0 and x < 10,x >= 0 and x < 2,x < 0 or x < 10,x > 0 or x < 10,x < 0 or x > 10
...
h = input("fourth number : ")
w = input("fifth number : ")
